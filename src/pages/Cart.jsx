...
const Cart = () => {
  ...
  useEffect(() => {
    // Total sum of all the cart items values
  ...
  return (
    <div className="mb-10">
      {
      cart.length > 0 ? (
        <div className="ml-6 sm:flex justify-center max-[1300px] mx-auto gap-x-5">
          {/* Cart Item  */}
          <div className="mx-auto w-[60%] flex flex-col p-2">
          ...
          {/* Summary */}
          <div className="ml-5 sm:w-[40%] mt-5 flex flex-col">
