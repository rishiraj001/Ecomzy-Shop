...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center p-5 justify-between mt-2 mb-2 mx-5 border-b-[3px] border-slate-500 ">
      <div className="sm:flex p-3 gap-5 items-center">
        <div className="w-[35%] mx-auto sm:w-[30%]">
          <img src={item.image} alt="added-cart" className="object-cover" />
        </div>
        <div className="mt-3 sm:w-[70%] self-start space-y-5 ml-5">
